...
export function SettingsForm() {
  return (
    <FadeIn className="max-w-[1000px] mx-auto py-8 px-4" suppressHydrationWarning>
      <div className="mb-10">
        <h1 className="text-3xl font-bold tracking-tight text-[#1c1d1f] dark:text-white mb-2">Account Settings</h1>
      ...
      <Tabs defaultValue="profile" className="flex flex-col md:flex-row gap-12">
        <TabsList className="flex md:flex-col h-auto bg-transparent border-none p-0 gap-2 md:w-64 shrink-0 overflow-x-auto md:overflow-visible no-scrollbar rounded-lg">
          <TabsTrigger 
            value="profile" 
            className="w-full justify-start gap-3 px-4 py-3 rounded-md border-l-[3px] border-transparent data-[state=active]:border-primary data-[state=active]:bg-muted/50 data-[state=active]:text-primary font-bold text-sm transition-all"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 max-w-xl">
                <div className="grid gap-2 text-left">
                  ...
                  <Input id="displayName" defaultValue="John Doe" className="h-12" />
                </div>
                
                <div className="grid gap-2 text-left">
                  <Label htmlFor="headline" className="font-bold">Headline</Label>
                  <Input id="headline" placeholder="e.g. Fullstack Developer & React Enthusiast" className="h-12" />
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 max-w-xl">
                <div className="grid gap-2 text-left">
                  ...
                  <Input id="email" type="email" defaultValue="john.doe@example.com" className="h-12" />
                </div>
              ...
              <div className="space-y-6 max-w-xl">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-bold">Course Updates</Label>
                    <p className="text-xs text-muted-foreground">Announcements from instructors for courses you're enrolled in.</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-muted-foreground">Get notified about sales, new courses, and special offers.</p>
                  </div>
                  <Switch />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-bold">Direct Messages</Label>
                    <p className="text-xs text-muted-foreground">Email notifications when you receive a message from an instructor.</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
          ...
          <TabsContent value="privacy" className="m-0 space-y-8 animate-in fade-in duration-300">
            <div className="space-y-6">
              ...
              <div className="space-y-6 max-w-xl">
                 <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-bold">Show profile to logged-in users</Label>
                    <p className="text-xs text-muted-foreground">Allow other students to see your bio and courses.</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-bold">Show courses you're taking on your profile</Label>
                    <p className="text-xs text-muted-foreground">Allow others to see your active learning list.</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
